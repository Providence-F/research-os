# -*- coding: utf-8 -*-
"""Research OS v1.5 - 工作流定义（机器可读单一真相源）
...
STEPS = [
    ...
    {"id": "step_8_red_team",              "num": "8",    "label": "反方审计",     "phase": "analyze", "artifact": "06-review/red_team.md"},
    ...
    {"id": "step_11_trace_manifest",       "num": "11",   "label": "溯源清单",     "phase": "deliver", "artifact": "07-output/trace-manifest.json"},
...
# 9 个门禁（编号与 templates/14-研究执行状态机.md 的「门禁 N」一致）
